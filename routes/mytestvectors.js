...
router.get('/', function (req, res, next) {
  ...
  User.findOne({_id: id}, 'username')
    ...
    .then(function (data) {
      ...
      return Testvector.find(requestOptions).deepPopulate('testcases attributeInstances testcases.feature attributeInstances.attribute testcases.feature.featureGroup')
    })
    .then(function (docs) {
